                ...
                while (!server.isClosed()) {
                    ...
                    try (OutputStream out = socket.getOutputStream()) {
                        ...
                        for (Post post : store.getAll()) {
                            out.write(post.getName().getBytes(StandardCharsets.UTF_16));
                            out.write(post.getUrl().getBytes(StandardCharsets.UTF_16));
                            out.write(post.getDescription().getBytes(StandardCharsets.UTF_16));
